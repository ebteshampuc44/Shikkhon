...
const Login = () => {
  ...
  const handleGoogleSignIn = () => {
    ...
    // এখানে গুগল সাইন-ইন লজিক যোগ করুন
  };
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-md w-full mx-4 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-700 text-lg">Continue your skills journey</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center">
                  <span className="px-4 bg-white/90 text-sm text-gray-500">Or continue with</span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full py-4 px-4 rounded-xl font-semibold text-gray-700 transition-all duration-500 transform hover:scale-[1.02] hover:shadow-2xl flex items-center justify-center gap-3 border-2"
                style={{
